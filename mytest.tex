% arara: latex : {shell: true, interaction: nonstopmode, options: "-recorder"}
% arara: dvips
% arara: ps2pdf : {options: "-dPDFSETTINGS=/prepress"}
%<*remove>
% ltximg : options : {arara,output = salida, imgdir = pics, prefix = env, eps,svg, subenv,force, clean = doc, norun} 
