...
Create separate files whit \emph{only code} for all extracted environments.

\DescribeCmd{srcenv}{bolean}{off}
Create sub files whit \emph{preamble} and code for all extracted environments.
...
\begin{description}[font=\small\sffamily, noitemsep,leftmargin=*]
