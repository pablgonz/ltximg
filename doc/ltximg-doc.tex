...
% Important words 1
    ...
    keywords=[1]{PassOptionsToPackage,AtBeginDocument,documentclass,usepackage},%
...
% rest of input file
\end{examplecode}
And save in a temporary file \sysfile{test-fig-1981.tex} in \sysdir{./}. This file will contain all the environments
...
And save in a temporary file \sysfile{test-fig-1981.tex} in \sysdir{./}. This file will contain the same preamble
of \sysfile{test.tex}, but the \meta{body} only contains contains the environments that you want to extract separated by \ics{newpage}.
...
An example\footnote{Adapted from \href{https://tex.stackexchange.com/a/114847}{Draw an aircraft with Tikz}}
...
The best airplane ever drawn by David Carlise. No packages used, just the
...
If you are a user of \scriptname{latexmk}, another
great utility that automates the compilation process, the procedure is analogous, you
just have to search (or write) the necessary \emph{\enquote{rule}} for \scriptname{latexmk} and pass to \arara.
