...
The script has been tested on \OSsystem{Windows} (v10), \OSsystem{cygwin} (v3.1.6) and %
\OSsystem{Linux} (fedora 33) using \prgname{ghostscript} %
\liningnums{v9.53.3}, \prgname{poppler-utils} \liningnums{v0.90}, \prgname{perl} \liningnums{v5.32}
